...
2. Prerequisite: Place the folder of your NMR data file (either a fully sampled FID in nmrPipe format or an already zero-filled undersampled FID) in the directory `Processed_data/BMRB_data/`. And then name the folder with `data`, which serves as the input of `process_direct.com`.
3. Preprocess NMR data:
